 ...
 * 	       wp eval-file wp-content/plugins/notification-buddypress/bin/dump-hooks.php
 *
 * @package notification/buddypress
 */

$runtime    = NotificationBuddyPress::runtime();
...
$objects = [];
foreach ( NotificationBuddyPress::components() as $component_name => $instance ) {
